...
FastAPI server for LangChain RAG (Retrieval-Augmented Generation) with Milvus vector store.
...
3. **Vector Store**: Creates/connects to Milvus collection with OpenAI embeddings
